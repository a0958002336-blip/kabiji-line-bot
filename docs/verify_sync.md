...
1. 在 LINE（老闆帳號）打 `#版本`，看第一行：
   ```
   📦 卡比集機器人 v3.4.1 (881e268) 2026/07/14
   ```
...
| 項目 | 值 |
|------|-----|
| 部署 commit（.gs 最後變更） | `f27cb24` |
| `#版本` 顯示 / `BOT_BUILD` | `881e268`（＝版本 commit，回填 commit 的父；兩者僅差 BOT_BUILD 一行） |
| git blob hash（`git rev-parse HEAD:卡比集機器人.gs`） | `1e77330e7f2c9b15a4c7e25b016997d8ac68dee1` |
| sha256（LF 正規化） | `0f8041a7fca82b301600db32636762fbf35952f004f5753055256ebaa12cf544` |
| 位元組數 / 行數 | `294698` / `4041` |
