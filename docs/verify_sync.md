...
1. 在 LINE（老闆帳號）打 `#版本`，看第一行：
   ```
   📦 卡比集機器人 v3.4.2 (fbee1c7) 2026/07/15
   ```
...
| 項目 | 值 |
|------|-----|
| 部署 commit（.gs 最後變更） | `8381277` |
| `#版本` 顯示 / `BOT_BUILD` | `fbee1c7`（＝版本 commit，回填 commit 的父；兩者僅差 BOT_BUILD 一行） |
| git blob hash（`git rev-parse HEAD:卡比集機器人.gs`） | `612afca385fda457e2428a074160509e06eb7757` |
| sha256（LF 正規化） | `4ba87afdf9958b35d3a32b90f97166ce0567c04949d518f67002970f814022e9` |
| 位元組數 / 行數 | `295415` / `4043` |
