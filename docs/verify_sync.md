...
1. 在 LINE（老闆帳號）打 `#版本`，看第一行：
   ```
   📦 卡比集機器人 v3.2.3 (334abeb) 2026/07/11
   ```
...
| 項目 | 值 |
|------|-----|
| 部署 commit（.gs 最後變更） | `14f94ec` |
| `#版本` 顯示 / `BOT_BUILD` | `334abeb`（＝版本 commit，回填 commit 的父；兩者僅差 BOT_BUILD 一行） |
| git blob hash（`git rev-parse HEAD:卡比集機器人.gs`） | `a9980352c1829c3fc0fed6621e9f9f0ef7ae6ecd` |
| sha256（LF 正規化） | `d35e9f5ac75737427aaf3f3c2341e8e7d4b96c61b1fcaa8f7983c631be627387` |
| 位元組數 / 行數 | `279242` / `3870` |
